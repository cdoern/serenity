  ...
  function getTimeData(){
    ...
    chrome.storage.sync.get('time', function(data){
      chrome.storage.sync.get('originalTime', function(orig){
        ...
        else if(diff > 0 && inf.infiniteMode != 1){ // if out of hours but not time then uch caused this
